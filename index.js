...
+ 'FN:Mr.Pato\n' // Nama
+ 'ORG:Mr.Pato-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=51961607422:+51 961 607 422\n' // Nomor bot
+ 'END:VCARD' 
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
	...
	Lxa.on('chat-update', async (mek) => {
      ...
      const is = budy.slice(0).trim().split(/ +/).shift().toLowerCase()
			mess = {
  wait: '⏳ Espera p mano mi huevada de movistar esta del asco ',
  success: '🎉 Con exito',
  Public: '🛡 Modo privado activado',
  ferr: 'Lo siento ocurrio un error especifica p gil tmb tiene que ir el nombre del cantante',
  limitend: 'El tiempo se agoto 5 minutos para cerrar? xd',
  error: {
...
┃─────〘  *List menu* 〙─────
   ...
   - Que pasa causa Gaaaaaaa.
   - A mi tmb me da Flojera leer.
   - El administrador es puto.
   - Y la administradora es una perra.
   - No mentira ella no, pero si quieres si.
